...
```{r}
typeof(3.14)
typeof(1L) # The L suffix forces the number to be an integer, since by default R uses floating point numbers
typeof(1+1i)
typeof(TRUE)
typeof('banana')
```
...
You can also make sequence of numbers using the `:` operator: 
